  ...
  Widget buildBoardItem(BoardItemObject itemObject) {
    return BoardItem(
        ...
        onDropItem: (int? listIndex, int? itemIndex, int? oldListIndex,
          ...
          var item = _listData[oldListIndex ?? 0].items![oldItemIndex ?? 0];

          _listData[oldListIndex ?? 0].items!.removeAt(oldItemIndex ?? 0);

          _listData[listIndex ?? 0].items!.insert(itemIndex ?? 0, item);
        },
        onTapItem:
  ...
  Widget _createBoardList(BoardListObject list) {
    ...
    return BoardList(
      ...
      onDropList: (int? listIndex, int? oldListIndex) {
        ...
        var list = _listData[oldListIndex ?? 0];
        _listData.removeAt(oldListIndex ?? 0);
        _listData.insert(listIndex ?? 0, list);
      },
