                ...
                children: [
                  ...
                  TextField(
                    decoration: InputDecoration(
                      hintText: _viewModel.items.full_name ?? "İsim giriniz.",
                  ...
                  TextField(
                    decoration: InputDecoration(
                      hintText:
                          _viewModel.items.user_name ?? "Kullanıcı adı giriniz.",
                      enabledBorder: OutlineInputBorder(
                        borderRadius: context.lowBorderRadius,
                        borderSide:
                            BorderSide(color: context.colorScheme.onBackground),
                  ...
                  TextField(
                    decoration: InputDecoration(
                      hintText: _viewModel.items.location ?? "Konumuzu giriniz.",
                      enabledBorder: OutlineInputBorder(
                        borderRadius: context.lowBorderRadius,
                        borderSide:
                            BorderSide(color: context.colorScheme.onBackground),
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: TextField(
                              decoration: InputDecoration(
                                hintText: _viewModel.items.company_name ?? "Şirket ismi giriniz.",
                                enabledBorder: OutlineInputBorder(
                                  borderRadius: context.lowBorderRadius,
                          ...
                          Expanded(
                            child: TextField(
                              decoration: InputDecoration(
                                hintText: _viewModel.items.job ?? "Meslek giriniz.",
                                enabledBorder: OutlineInputBorder(
                                  borderRadius: context.lowBorderRadius,
                                  borderSide: BorderSide(
                                      color: context.colorScheme.onBackground),
